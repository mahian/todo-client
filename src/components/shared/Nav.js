        ...
        <div className="bg-gray-900 px-4">
            <nav className="container mx-auto flex items-center justify-between flex-wrap py-6">
                ...
                <div className="block lg:hidden">
                    <button onClick={collaps} className="flex items-center px-3 py-2 border rounded text-white border-white hover:text-white hover:border-white">
                        <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
                    </button>
                </div>
                <div className={`${!open? "hidden" : "block"} w-full flex-grow lg:flex lg:items-center lg:w-auto lg:ml-10`}>
